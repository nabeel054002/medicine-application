...
func (c *Coupon) Validate() error {
	...
	// in the starting we can have it not applicable for any medicine_id or category
	// // Check applicable categories and medicine IDs if necessary
	// if len(c.ApplicableForCategories) == 0 && len(c.ApplicableForMedicineIds) == 0 {
	// 	return fmt.Errorf("At least one of 'applicable_for_categories' or 'applicable_for_medicine_ids' must be provided")
	// }
